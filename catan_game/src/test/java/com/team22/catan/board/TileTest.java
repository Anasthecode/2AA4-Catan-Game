...
public class TileTest {
  ...
  public void cornersTest() {
    ...
    assertEquals(new NodePosition(0, 1,  RelativeNodeLocation.NORTH), corners.get(1));
    assertEquals(new NodePosition(0, 0,  RelativeNodeLocation.SOUTH), corners.get(2));
    assertEquals(new NodePosition(-1, 1, RelativeNodeLocation.NORTH), corners.get(3));
    assertEquals(new NodePosition(0, -1, RelativeNodeLocation.SOUTH), corners.get(4));
    assertEquals(new NodePosition(0, 0,  RelativeNodeLocation.NORTH), corners.get(5));
  }
